        ...
        <div className='bg-white text-[#0A0A0A] font-sans min-h-screen overflow-x-hidden:'>
            ...
            <motion.nav
                ...
                <div className='flex items-center gap-2'>
                    <div className='w-7 h-7 rounded-lg bg-[#0A0A0A] flex items-center justify-center shadow-[0_4px_14px_rgba(0,0,0,0.18)]'><PiStudentBold size={15} color='white' /></div>
                    <span className='font-extrabold text-base tracking-tight text-[#0A0A0A]'>SmarterAI</span>
            ...
            <section className='relative pt-20 pb-14 overflow-hidden bg-[#F8F9FA]'>
                ...
                <div className='max-w-4xl mx-auto px-6 text-center'>
                    <motion.div
                        ...
                        className='inline-flex items-center px-3 py-1.5 rounded-full border border-black/15 bg-black/15 bg-black/5 text-black/70 text-xs font-medium mb-4'>
                    ...
                    <motion.p
                        ...
                        SmarterAI is an innovative AI-powered interview preparation platform designed to help job seekers excel in their interviews.
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                <div className='max-w-5xl mx-auto px-6 '>
                    <div className='text-center mb-10'>
                        ...
                        <p className='text-black/40 text-sm max-w-2xl mx-auto mt-4 leading-relaxed'>
                            SmarterAI combines multiple AI Agents that work together to help you build you resume, practice interviews, received detailed feedback, and follows a personalized roadmap to land your dream job.
                        </p>
                    </div>
                            ...
                            [
                                {
                                    icon: <FiFileText />,
                                    title: "Resume Agents",
                                    desc: "Creates ATS Friendly resumes, improve profile strength and maximize interview opportunities."
                                },
...

                                {
                                    ...
                                    desc: "Get detailed answer analytics, scoring reports and recommendations."
                                },

                                {
                                    icon: <FiMap />,
                                    title: "Roadmap Agents",
                                    desc: "Generates Personizd learning roadmaps."
                                ...
                                return (
                                    <motion.div key={i}
                                        ...
                                        <div className='absolute inset-0 bg-gradient-to-br from-white/[0.08] via-transparent to-transparent pointer-event-none' />
                                        ...
                                        <div className='relative'>
                                            <div className='w-11 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 flex items-center jusitfy-center text-white text-lg mb-4 shadow-inner'>{agent.icon}</div>
            ...
            <div className='flex items-center justify-center gap-2 mb-1.5'>
                ...
                <span className='font-bold text-xs text-[#0A0A0A]/70'>SmarterAI</span>
            </div>

            <div className='text-black/50 text-xs'>
                {new Date().getFullYear()} SmarterAI .All right reserved
            </div>
