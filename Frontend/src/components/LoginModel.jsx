            ...
            <div className='relative w-full max-w-sm bg-[#0A0A0A]/80 backdrop-blur-2xl border border-white/10 rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.25)]'>
                ...
                <div className='relative p-7'>
                    ...
                    <h2 className='text-lg font-bold text-center mb-2 text-white'>
                        Sign In to  <span className='font-extrabold text-lg tracking-tight text-white'>Smarter AI</span>
                    </h2>
                    <p className='text-white/45 text-center text-x5'>
                        Continue you AI interview Journey
                    </p>
                ...
                <div className='relative border-t border-white/10 bg-black/30 p-4 text-center'>
                        <p className='text-white/30 text-x5'> 
                            Secured Authentication powered by FIrebase
                        </p>
                </div>
